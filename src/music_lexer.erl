...
yystate(10, [10|Ics], Line, Tlen, _, _) ->
    yystate(11, Ics, Line+1, Tlen+1, 8, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 71 ->
...
-file("src/music_lexer.xrl", 5).
yyaction_0(TokenLine) ->
     { token, { lambda, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/music_lexer.xrl", 6).
yyaction_1(TokenLine) ->
     { token, { left_paren, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/music_lexer.xrl", 7).
yyaction_2(TokenLine) ->
     { token, { right_paren, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/music_lexer.xrl", 8).
yyaction_3(TokenLine) ->
     { token, { dot, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/music_lexer.xrl", 9).
yyaction_4(TokenLine) ->
     { token, { l_bracket, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/music_lexer.xrl", 10).
yyaction_5(TokenLine) ->
     { token, { r_bracket, TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/music_lexer.xrl", 11).
yyaction_6(TokenLine) ->
     { token, { l_chevron, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/music_lexer.xrl", 12).
yyaction_7(TokenLine) ->
     { token, { r_chevron, TokenLine } } .

-compile({inline,yyaction_8/2}).
-file("src/music_lexer.xrl", 13).
yyaction_8(TokenChars, TokenLine) ->
     { token, { note, TokenLine, TokenChars } } .

-compile({inline,yyaction_9/2}).
-file("src/music_lexer.xrl", 14).
yyaction_9(TokenChars, TokenLine) ->
     { token, { variable, TokenLine, TokenChars } } .

-compile({inline,yyaction_10/0}).
-file("src/music_lexer.xrl", 15).
yyaction_10() ->
     skip_token .
